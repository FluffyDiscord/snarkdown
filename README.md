...
> **Fork of [developit/snarkdown](https://github.com/developit/snarkdown).** Adds pipe tables, links bare `http(s)://` URLs, and turns blank-line separated text into `<p>` paragraphs (single-paragraph input stays unwrapped).
